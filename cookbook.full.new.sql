...
--
-- Table structure for table `cb_recipes`
--

DROP TABLE IF EXISTS `cb_recipes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cb_recipes` (
...
--
-- Dumping data for table `cb_recipes`
--

LOCK TABLES `cb_recipes` WRITE;
/*!40000 ALTER TABLE `cb_recipes` DISABLE KEYS */;
/*!40000 ALTER TABLE `cb_recipes` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `cb_recipes_groups_lnk`
--

DROP TABLE IF EXISTS `cb_recipes_groups_lnk`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cb_recipes_groups_lnk` (
  `recipe_group_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `recipe_id` int(10) unsigned NOT NULL,
  `group_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`recipe_group_id`),
  KEY `recipe_id` (`recipe_id`),
  KEY `group_id` (`group_id`),
  CONSTRAINT `cb_recipes_groups_lnk_ibfk_1` FOREIGN KEY (`recipe_id`) REFERENCES `cb_recipes` (`recipe_id`),
  CONSTRAINT `cb_recipes_groups_lnk_ibfk_2` FOREIGN KEY (`group_id`) REFERENCES `cb_groups` (`group_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cb_recipes_groups_lnk`
--

LOCK TABLES `cb_recipes_groups_lnk` WRITE;
/*!40000 ALTER TABLE `cb_recipes_groups_lnk` DISABLE KEYS */;
/*!40000 ALTER TABLE `cb_recipes_groups_lnk` ENABLE KEYS */;
UNLOCK TABLES;
